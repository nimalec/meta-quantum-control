...
def generate_figure2(
    ...
    if run_experiments:
        ...
        results_detuning = run_gap_vs_diversity_experiment(
            ...
            diversity_levels=[1.0, 2.0, 3.0, 4.0, 6.0, 7, 8, 9, 10],
            K_fixed=7,
            n_test_tasks=60
        )
        ...
        try:
            results_decoherence = run_gap_vs_diversity_experiment(
                ...
                diversity_levels=[0.05, 0.10, 0.15, 0.20, 0.30,0.4],
                K_fixed=7,
                n_test_tasks=60
            )
        except Exception as e:
...
if __name__ == "__main__":
    ...
    # Find checkpoints 
    meta_path =  "../train_scripts/checkpoints/maml_best_pauli_x_policy.pt"
