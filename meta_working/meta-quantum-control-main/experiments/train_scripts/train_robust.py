...
def main(config_path: str):
    ...
    policy = PulsePolicy(
        ...
        n_segments=config.get('n_segments', 200),
    ...
    robust_policy = RobustPolicy(
        policy=policy,
        learning_rate=config.get('meta_lr', 0.01),  # Use same LR as meta
    ...
    save_path = save_dir / f"robust_minimax.pt"
    ...
    trainer.train(
        ...
        val_tasks=config.get('val_tasks',2),
